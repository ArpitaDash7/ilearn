...
if($_SERVER['REQUEST_METHOD']=='POST')
{
  ...
  if(isset($_POST['sno']))
  {
    ...
    $sql="UPDATE `events` SET `wishlist` = '0' WHERE `events`.`event_id` = '$snoEdit';"; 
...
<body style="background-color:rgb(239, 236, 229);">
    ...
    <div class="yahoo">
    <?php
        $sql= "SELECT * FROM events where wishlist= '1'";
        ...
        if($result->num_rows > 0){
            while($row= $result->fetch_assoc()){
                ...
                <figcaption>
                    ...
                    <button class="add" id="'.$row['event_id'].' ">Remove from wihlist</button>
...
<form action="search1.php" method="post" id="wishlist">
